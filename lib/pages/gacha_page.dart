                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: (_isLoading || _credit < 150) ? null : _performGacha,
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: Colors.transparent,
                                    ...
                                    : Column(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Icon(
                                                Icons.auto_awesome,
                                                size: 16,
                                                color: (_credit < 150) ? Colors.grey : Colors.black87,
                                              ),
                                              SizedBox(width: 6),
                                              Text(
                                                'GACHA 1x',
                                          ...
                                          Text(
                                            ...
                                            style: TextStyle(
                                              fontSize: 10,
                                              color: (_credit < 150) ? Colors.red : Colors.black54,
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: (_isLoading10x || _credit < 1500) ? null : _perform10xGacha,
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: Colors.transparent,
                                  shadowColor: Colors.transparent,
                                  padding: EdgeInsets.symmetric(
                                    ...
                                    : Column(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Icon(
                                                ...
                                                size: 16,
                                                color: (_credit < 1500) ? Colors.grey : Colors.black87,
                                              ),
                                              SizedBox(width: 6),
                                              Text(
                                                'GACHA 10x',
                                          ...
                                          Text(
                                            ...
                                            style: TextStyle(
                                              fontSize: 10,
                                              color: (_credit < 1500) ? Colors.red : Colors.black54,
                                              fontWeight: FontWeight.w500,
                                            ),
                                          ),
                                        ],
